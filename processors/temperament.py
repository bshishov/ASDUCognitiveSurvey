...
def temperament(text_data, **kwargs) -> dict:
    ...
    return {
        'neurotism_score': neurotism_score,
        'neurotism_score_comment': neurotism_score_comment,
        'lie_score': lie_score,
        'lie_score_comment': lie_score_comment,
        'extravert_score': extravert_score,
        'extravert_score_comment': extravert_score_comment
    }


if __name__ == '__main__':
    default_main(temperament)
